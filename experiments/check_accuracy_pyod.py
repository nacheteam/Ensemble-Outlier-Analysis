...
models = [ABOD(), AutoEncoder(hidden_neurons = [4,4,4,4], verbose=0), COF(), FeatureBagging(), HBOS(), IForest(), KNN(), LOF(), LOCI(), MCD(), MO_GAAL(), OCSVM(), PCA(), SOD(), SO_GAAL(), SOS(), XGBOD()]
names = ["ABOD", "Auto_Encoder", "COF", "Feature_Bagging", "HBOS", "IForest", "KNN", "LOF", "LOCI", "MCD", "MO_GAAL", "OCSVM", "PCA", "SOD", "SO_GAAL", "SOS", "XGBOD"]
accuracies = []
